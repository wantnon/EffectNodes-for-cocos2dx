...
bool Clayer_colorAdjust::init()
{
     ...
     //slider
	{
		...
		CCControlSlider *slider = CCControlSlider::create("uiRes/sliderTrack_long.png",
		...
		slider->addTargetWithActionForControlEvents(this, cccontrol_selector(Clayer_colorAdjust::sliderAction), CCControlEventValueChanged);
		m_pSliderCtl=slider;
	...
	//slider2
    {
		...
		slider->addTargetWithActionForControlEvents(this, cccontrol_selector(Clayer_colorAdjust::sliderAction2), CCControlEventValueChanged);
    ...
    //slider3
    {
		...
		slider->addTargetWithActionForControlEvents(this, cccontrol_selector(Clayer_colorAdjust::sliderAction3), CCControlEventValueChanged);
    ...
    //back button
    {
        ...
        controlButton->addTargetWithActionForControlEvents(this, (SEL_CCControlHandler)(&Clayer_colorAdjust::controlButtonEvent_back), CCControlEventTouchUpInside);
...
void Clayer_colorAdjust::controlButtonEvent_back(CCObject *senderz, cocos2d::extension::CCControlEvent controlEvent){
...
void Clayer_colorAdjust::sliderAction(CCObject* sender, CCControlEvent controlEvent)
{
...
void Clayer_colorAdjust::sliderAction2(CCObject* sender, CCControlEvent controlEvent)
{
    CCControlSlider* pSlider = (CCControlSlider*)sender;
    float value=pSlider->getValue();
...
void Clayer_colorAdjust::sliderAction3(CCObject* sender, CCControlEvent controlEvent)
{
    CCControlSlider* pSlider = (CCControlSlider*)sender;
    float value=pSlider->getValue();
